...
<script src= "<?= base_url('assets/adminlte/plugins/moment/moment.mn.js')?>"></script>
<script src= "<?= base_url('assets/adminlte/plugins/daterangepicker/daterangepicker.js')?>"></script>
<script src= "<?= base_url('assets/adminlte/plugins/tempusdominus-bootsrap-4/js/tempusdominus-bootsrap-4.min.js')?>"></script>
